...
-   [:octicons-git-pull-request-16:{ .lg .middle } __Submit change requests__](guide/cr.md) <!-- gs:icon:github --> <!-- gs:icon:gitlab --> <!-- gs:icon:bitbucket --> <!-- gs:icon:forgejo -->
...
-   [:material-cloud-off-outline:{ .lg .middle } __Offline-first__](guide/internals.md)
    ...
    to GitHub/GitLab/Bitbucket/Forgejo.
